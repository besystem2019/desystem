 ...
 * @author wwwki
 */
public class jfDetalle_f extends javax.swing.JFrame {
...
//        this.setIconImage(new ImageIcon(getClass().getResource("/Iconos/bender_cyco.png")).getImage());
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblLineaInferio1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 600, 7));
        jPanel1.add(lblLineaInferio2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 600, 7));
        jPanel1.add(lblLineaInferio3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 600, 7));
...
//                af.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfDetalle_f.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfDetalle_f().setVisible(true);
            }
        });
    }
